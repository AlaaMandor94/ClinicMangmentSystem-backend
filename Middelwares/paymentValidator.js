...
let paymentValidator = [
  body("amount").isInt().isEmpty().withMessage("Amount is required").isNumeric().withMessage("Amount must be a number"),
  body("card_number").isInt().isEmpty().withMessage("Card number is required"),
  ...
  body("cvc").isInt().isEmpty().withMessage("CVC is required").isNumeric().withMessage("CVC must be a number"),
];
